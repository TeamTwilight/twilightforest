...
public class AtlasGenerator extends SpriteSourceProvider {
	...
	protected void gather() {
		this.atlas(AtlasIds.SHIELD_PATTERNS).addSource(new SingleFile(TwilightForestMod.prefix("entity/knightmetal_shield"), Optional.of(TwilightForestMod.prefix("entity/shield/knightmetal_shield"))));
