...
public class TFEntities {
	...
	public static void registerEntities(RegistryEvent.Register<EntityType<?>> evt) {
		...
		EntitySpawnPlacementRegistry.register(kobold, EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, MonsterEntity::canMonsterSpawn);
		...
		EntitySpawnPlacementRegistry.register(death_tome, EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, MonsterEntity::canMonsterSpawn);
		EntitySpawnPlacementRegistry.register(minotaur, EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, MonsterEntity::canMonsterSpawn);
		...
		EntitySpawnPlacementRegistry.register(fire_beetle, EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, MonsterEntity::canMonsterSpawn);
		...
		EntitySpawnPlacementRegistry.register(blockchain_goblin, EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, MonsterEntity::canMonsterSpawn);
		EntitySpawnPlacementRegistry.register(goblin_knight_upper, EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, MonsterEntity::canMonsterSpawn);
		EntitySpawnPlacementRegistry.register(goblin_knight_lower, EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, MonsterEntity::canMonsterSpawn);
		EntitySpawnPlacementRegistry.register(helmet_crab, EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, MonsterEntity::canMonsterSpawn);
		...
		EntitySpawnPlacementRegistry.register(king_spider, EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, MonsterEntity::canMonsterSpawn);
		...
		EntitySpawnPlacementRegistry.register(redcap_sapper, EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, MonsterEntity::canMonsterSpawn);
		...
		EntitySpawnPlacementRegistry.register(snow_guardian, EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, MonsterEntity::canMonsterSpawn);
	...
	public static void addEntityAttributes() {
		GlobalEntityTypeAttributes.put(wild_boar, PigEntity.func_234215_eI_().create());
		GlobalEntityTypeAttributes.put(bighorn_sheep, SheepEntity.func_234225_eI_().create());
		GlobalEntityTypeAttributes.put(deer, EntityTFDeer.registerAttributes().create());
		GlobalEntityTypeAttributes.put(redcap, EntityTFRedcap.registerAttributes().create());
		GlobalEntityTypeAttributes.put(swarm_spider, EntityTFSwarmSpider.registerAttributes().create());
		GlobalEntityTypeAttributes.put(naga, EntityTFNaga.registerAttributes().create());
		GlobalEntityTypeAttributes.put(skeleton_druid, MonsterEntity.func_234295_eP_().create());
		GlobalEntityTypeAttributes.put(hostile_wolf, EntityTFHostileWolf.registerAttributes().create());
		GlobalEntityTypeAttributes.put(wraith, EntityTFWraith.registerAttributes().create());
		GlobalEntityTypeAttributes.put(hedge_spider, SpiderEntity.func_234305_eI_().create());
		GlobalEntityTypeAttributes.put(hydra, EntityTFHydra.registerAttributes().create());
		GlobalEntityTypeAttributes.put(lich, EntityTFLich.registerAttributes().create());
		GlobalEntityTypeAttributes.put(penguin, EntityTFPenguin.registerAttributes().create());
		GlobalEntityTypeAttributes.put(lich_minion, ZombieEntity.func_234342_eQ_().create());
		GlobalEntityTypeAttributes.put(loyal_zombie, EntityTFLoyalZombie.registerAttributes().create());
		GlobalEntityTypeAttributes.put(tiny_bird, EntityTFTinyBird.registerAttributes().create());
		GlobalEntityTypeAttributes.put(squirrel, EntityTFSquirrel.registerAttributes().create());
		GlobalEntityTypeAttributes.put(bunny, EntityTFBunny.registerAttributes().create());
		GlobalEntityTypeAttributes.put(raven, EntityTFRaven.registerAttributes().create());
		GlobalEntityTypeAttributes.put(quest_ram, EntityTFQuestRam.registerAttributes().create());
		GlobalEntityTypeAttributes.put(kobold, EntityTFKobold.registerAttributes().create());
		GlobalEntityTypeAttributes.put(mosquito_swarm, EntityTFMosquitoSwarm.registerAttributes().create());
		GlobalEntityTypeAttributes.put(death_tome, EntityTFDeathTome.registerAttributes().create());
		GlobalEntityTypeAttributes.put(minotaur, EntityTFMinotaur.registerAttributes().create());
		GlobalEntityTypeAttributes.put(minoshroom, EntityTFMinoshroom.registerAttributes().create());
		GlobalEntityTypeAttributes.put(fire_beetle, EntityTFFireBeetle.registerAttributes().create());
		GlobalEntityTypeAttributes.put(slime_beetle, EntityTFSlimeBeetle.registerAttributes().create());
		GlobalEntityTypeAttributes.put(pinch_beetle, EntityTFPinchBeetle.registerAttributes().create());
		GlobalEntityTypeAttributes.put(maze_slime, EntityTFMazeSlime.registerAttributes().create());
		...
		GlobalEntityTypeAttributes.put(tower_termite, EntityTFTowerTermite.registerAttributes().create());
		GlobalEntityTypeAttributes.put(tower_broodling, EntityTFTowerBroodling.registerAttributes().create());
		GlobalEntityTypeAttributes.put(ur_ghast, EntityTFUrGhast.registerAttributes().create());
		GlobalEntityTypeAttributes.put(blockchain_goblin, EntityTFBlockGoblin.registerAttributes().create());
		GlobalEntityTypeAttributes.put(goblin_knight_upper, EntityTFGoblinKnightUpper.registerAttributes().create());
		GlobalEntityTypeAttributes.put(goblin_knight_lower, EntityTFGoblinKnightLower.registerAttributes().create());
		GlobalEntityTypeAttributes.put(helmet_crab, EntityTFHelmetCrab.registerAttributes().create());
		GlobalEntityTypeAttributes.put(knight_phantom, EntityTFKnightPhantom.registerAttributes().create());
		GlobalEntityTypeAttributes.put(yeti, EntityTFYeti.registerAttributes().create());
		GlobalEntityTypeAttributes.put(yeti_alpha, EntityTFYetiAlpha.registerAttributes().create());
		GlobalEntityTypeAttributes.put(winter_wolf, EntityTFWinterWolf.registerAttributes().create());
		GlobalEntityTypeAttributes.put(snow_guardian, EntityTFSnowGuardian.registerAttributes().create());
		GlobalEntityTypeAttributes.put(stable_ice_core, EntityStableIceCore.registerAttributes().create());
		GlobalEntityTypeAttributes.put(unstable_ice_core, EntityUnstableIceCore.registerAttributes().create());
		GlobalEntityTypeAttributes.put(snow_queen, EntityTFSnowQueen.registerAttributes().create());
		GlobalEntityTypeAttributes.put(troll, EntityTFTroll.registerAttributes().create());
		GlobalEntityTypeAttributes.put(giant_miner, EntityTFGiantMiner.registerAttributes().create());
		GlobalEntityTypeAttributes.put(armored_giant, EntityTFGiantMiner.registerAttributes().create());
		GlobalEntityTypeAttributes.put(ice_crystal, EntityTFIceCrystal.registerAttributes().create());
	...
	public static void registerEntityRenderer() {
		...
		RenderingRegistry.registerEntityRenderingHandler(tiny_bird, m -> new RenderTFTinyBird(m, new ModelTFTinyBird(), 0.3F));
		...
		RenderingRegistry.registerEntityRenderingHandler(raven, m -> new RenderTFBird<>(m, new ModelTFRaven(), 0.3F, "raven.png"));
