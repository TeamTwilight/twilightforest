...
public class EntityTFBunny extends EntityCreature implements IAnimals {
	...
	protected void initEntityAI() {
		...
		this.tasks.addTask(3, new EntityAITempt(this, 1.0D, Items.CARROT, true));
		this.tasks.addTask(3, new EntityAITempt(this, 1.0D, Items.GOLDEN_CARROT, true));
		this.tasks.addTask(3, new EntityAITempt(this, 1.0D, Item.getItemFromBlock(Blocks.YELLOW_FLOWER), true));
