...
public class BakedMultiPartRenderers {
	private static final Map<Identifier, Supplier<? extends EntityRenderer<?, ?>>> renderers = new HashMap<>();
	...
	public static EntityRenderer<?, ?> lookup(Identifier location) {
		Supplier<? extends EntityRenderer<?, ?>> supplier = renderers.get(location);
