...
public class OptifineWarningScreen extends Screen {
	...
	private static final Component text = new TranslatableComponent(MOD_ID + ".gui.optifine.message");
	private static final MutableComponent url;
	private final List<Button> exitButton = Lists.newArrayList();

	static {
		(url = new TranslatableComponent(MOD_ID + ".gui.optifine.suggestions"))
	...
	protected OptifineWarningScreen(Screen screen) {
		super(new TranslatableComponent(MOD_ID + ".gui.optifine.title"));
