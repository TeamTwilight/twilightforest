...
public class RovingCubeRenderer<T extends RovingCube> extends EntityRenderer<T, CubeOfAnnihilationRenderState> {
	...
	@Override
	public void extractRenderState(T entity, CubeOfAnnihilationRenderState state, float partialTicks) {
