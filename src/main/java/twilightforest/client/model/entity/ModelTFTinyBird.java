...
public class ModelTFTinyBird<T extends EntityTFTinyBird> extends AgeableModel<T> {
	...
	public ModelTFTinyBird() {
		...
		head.addCuboid(-1.5F, -1.5F, -1.5F, 3, 3, 3);
		...
		beak.addCuboid(-0.5F, -0.5F, -0.5F, 1, 1, 1);
