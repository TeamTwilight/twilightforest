...
public class TFEntities {
	...
	public static final DeferredHolder<EntityType<?>, EntityType<Boat>> VEILWOOD_BOAT = registerMisc("veilwood_boat", EntityType.Builder.<Boat>of((type, level) -> new Boat(type, level, TFItems.VEILWOOD_BOAT), MobCategory.MISC).sized(1.375F, 0.5625F).eyeHeight(0.5625F).clientTrackingRange(10));
	public static final DeferredHolder<EntityType<?>, EntityType<ChestBoat>> VEILWOOD_CHEST_BOAT = registerMisc("veilwood_chest_boat", EntityType.Builder.<ChestBoat>of((type, level) -> new ChestBoat(type, level, TFItems.VEILWOOD_CHEST_BOAT), MobCategory.MISC).sized(1.375F, 0.5625F).eyeHeight(0.5625F).clientTrackingRange(10));
