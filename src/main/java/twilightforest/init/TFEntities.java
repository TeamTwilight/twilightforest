...
public class TFEntities {
	...
	public static final DeferredHolder<EntityType<?>, EntityType<Lich>> LICH = registerWithEgg("lich", EntityType.Builder.<Lich>of(Lich::new, MobCategory.MONSTER).sized(1.1F, 2.1F), Lich::registerAttributes, Monster::checkAnyLightMonsterSpawnRules);
