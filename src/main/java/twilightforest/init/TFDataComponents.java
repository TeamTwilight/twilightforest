...
public class TFDataComponents {
	...
	public static final DeferredHolder<DataComponentType<?>, DataComponentType<Float>> CONTROLLED_FALLING_TARGET_VELOCITY = COMPONENTS.register("controlled_falling_target_velocity", () -> DataComponentType.<Float>builder().persistent(ExtraCodecs.POSITIVE_FLOAT).networkSynchronized(ByteBufCodecs.FLOAT).cacheEncoding().build());
	public static final DeferredHolder<DataComponentType<?>, DataComponentType<Float>> CONTROLLED_FALLING_TAU = COMPONENTS.register("controlled_falling_tau", () -> DataComponentType.<Float>builder().persistent(ExtraCodecs.POSITIVE_FLOAT).networkSynchronized(ByteBufCodecs.FLOAT).cacheEncoding().build());
