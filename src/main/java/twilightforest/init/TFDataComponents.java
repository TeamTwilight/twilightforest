...
public class TFDataComponents {
	...
	public static final DeferredHolder<DataComponentType<?>, DataComponentType<Boolean>> TRAVELLERS_HAS_BOOTS = COMPONENTS.register("has_travellers_boots", () -> DataComponentType.<Boolean>builder().persistent(Codec.BOOL).networkSynchronized(ByteBufCodecs.BOOL).cacheEncoding().build());
	...
	public static final DeferredHolder<DataComponentType<?>, DataComponentType<Boolean>> ARROW_MAGNETISM = COMPONENTS.register("arrow_magnetism", () -> DataComponentType.<Boolean>builder().persistent(Codec.BOOL).networkSynchronized(ByteBufCodecs.BOOL).cacheEncoding().build());
	...
	public static final DeferredHolder<DataComponentType<?>, DataComponentType<Long>> SIDESTEP_COOLDOWN = COMPONENTS.register("sidestep_coolddown", () -> DataComponentType.<Long>builder().persistent(Codec.LONG).networkSynchronized(ByteBufCodecs.VAR_LONG).cacheEncoding().build());
