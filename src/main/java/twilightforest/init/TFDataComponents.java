...
public class TFDataComponents {
	...
	public static final DeferredHolder<DataComponentType<?>, DataComponentType<Unit>> IS_USING_GOGGLES_ZOOM = COMPONENTS.register("is_using_goggles_zoom", () -> DataComponentType.<Unit>builder().persistent(Unit.CODEC).networkSynchronized(Unit.STREAM_CODEC).cacheEncoding().build());
