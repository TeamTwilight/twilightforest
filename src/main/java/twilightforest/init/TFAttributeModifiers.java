...
public class TFAttributeModifiers {
	...
	public static final AttributeModifier EFFICIENT_EATER = new AttributeModifier(TwilightForestMod.prefix("travellers_gear.vest_efficient_eater"), 1F, AttributeModifier.Operation.ADD_VALUE);
}
