...
public class TFAttributes {
	...
	public static final DeferredHolder<Attribute, Attribute> TRAVEL_FOOD_EFFICIENCY = ATTRIBUTES.register("travel_food_efficiency", () -> new PercentageAttribute("attribute.name.travel_food_efficiency", 1, 1E-6, 1E6).setSyncable(true));
}
