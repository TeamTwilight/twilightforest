...
public class TFRecipes {
	...
	public static final DeferredHolder<RecipeSerializer<?>, RecipeSerializer<TravellersGearModifierRecipe>> MODIFIER_SERIALIZER = RECIPE_SERIALIZERS.register("travellers_gear_modifier", TravellersGearModifierRecipe.Serializer::new);
