...
public class TFPlacedFeatures {
	...
	public static void bootstrap(BootstrapContext<PlacedFeature> context) {
		...
		context.register(PLACED_ENCHANTED_FOREST_VINES, new PlacedFeature(features.getOrThrow(VegetationFeatures.VINES), ImmutableList.<PlacementModifier>builder().add(CountPlacement.of(127), InSquarePlacement.spread(), HeightRangePlacement.uniform(VerticalAnchor.absolute(-3), VerticalAnchor.absolute(10)), BiomeFilter.biome()).build()));  // [VanillaCopy] with changes in VerticalAnchors.
