		...
		for (int x = 1; x < 14; x++) {
			for (int z = 1; z < 14; z++) {
				...
				if (gravel > 0) {
					...
					this.fillWithBlocks(world, sbb, x, 5 - rand.nextInt(5), z, x, 5, z, TFBlocks.plantHanging.getDefaultState().withProperty(BlockTFPlant.VARIANT, ROOT_STRAND), AIR, false);
